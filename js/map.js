...
function initMap() {
    const mapParams = {
        center: {lat: 50.081864, lng: 20.003185},
        zoom: 16,
    ...
    google.maps.event.addListener(
        marker,
        'click',
        ()=>window.open('https://www.google.com/maps/dir/?api=1&destination=QVB&destination_place_id=ChIJVcjxTjNFFkcRL-q6tBI5DeY', '_blank')
    );
}
